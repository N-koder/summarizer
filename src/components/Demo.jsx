			// Summary part of Article
import React , {useState , useEffect} from 'react'

import {copy , linkIcon , loader , tick} from '../accessories/assets';
		...
		<section className = 'mt-16 w-full max-w-xl'>
			...
			<div className = 'flex flex-col w-full gap-2'>
				<form className = 'relative flex justify-center items-center' onSubmit = {handleSubmit}>
					...
					<img  className = "absolute left-0 my-2 ml-3 w-5" src= {linkIcon} alt = "link"/>

					<input type = 'url' placeholder = 'Enter url here' value = {article.url} onChange = {(e)=> setArticle({...article , url : e.target.value})} required className = 'url_input peer'/>
				...
				{/* browse history */}
				<h3 className = 'font-satoshi font-bold text-gray-600 text-xl'> Previous links: </h3>
